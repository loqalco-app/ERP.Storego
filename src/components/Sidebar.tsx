...
const NAV = [
  {
    section: 'Principal',
    items: [
      { key: 'dashboard', href: '/dashboard', label: 'Dashboard', icon: <path d="M10.707 2.293a1 1 0 0 1 1.414 0l7 7A1 1 0 0 1 19 11h-1v9a1 1 0 0 1-1 1h-4v-5h-2v5H7a1 1 0 0 1-1-1v-9H5a1 1 0 0 1-.707-1.707l7-7z"/>, fill: true },
      { key: 'orders',    href: '/orders',    label: 'Órdenes',   icon: <><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-4 0v2M8 7V5a2 2 0 0 0-4 0v2"/></>, fill: false },
      { key: 'pos',       href: '/pos',       label: 'POS',        icon: <><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></>, fill: false },
    ],
  },
  {
    section: 'Catálogo',
  ...
  },
  {
    section: 'Clientes',
    items: [
      { key: 'customers', href: '/customers', label: 'CRM',        icon: <><circle cx="9" cy="7" r="4"/><path d="M3 21a6 6 0 0 1 12 0"/><circle cx="17" cy="10" r="3"/><path d="M21 21a4 4 0 0 0-6 0"/></>, fill: false },
      { key: 'reports',   href: '/reports',   label: 'Reportes',   icon: <><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></>, fill: false },
    ],
  },
  {
    section: 'Sistema',
    items: [
      { key: 'users',    href: '/settings/users',   label: 'Usuarios y roles', icon: <><circle cx="12" cy="8" r="4"/><path d="M4 20a8 8 0 0 1 16 0"/></>, fill: false },
      { key: 'settings', href: '/settings',          label: 'Configuración',    icon: <><circle cx="12" cy="12" r="3"/><path d="M12 2v2M12 20v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M2 12h2M20 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></>, fill: false },
    ],
  },
]
  ...
  return (
    <>
      <style>{`
        ...
        .sb-user { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border-radius: 12px; text-decoration: none; cursor: pointer; }
        ...
        <div className="sb-footer">
          <Link href="/settings/profile" className="sb-user">
            ...
            <div>
              ...
              <div className="sb-urole">Editar perfil →</div>
            </div>
          </Link>
